...
## Compilation
Ne jamais compiler à ma place. C'est toujours moi qui lance le build (`make`, `build.bat`, `do_build.bat`) et qui teste. Après toute modification de code, s'arrêter et indiquer que l'implémentation est terminée.
