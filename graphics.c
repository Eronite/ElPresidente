...
void draw_presidente_bkg(uint8_t row1) {
    ...
    SWITCH_ROM(saved);
    static const uint8_t r1[12] = {0x3D,0x3E,0,0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x48,0x49};
    static const uint8_t r2[12] = {0x3F,0x40,0,0x4A,0x4B,0x4C,0x4D,0x4E,0x4F,0x50,0x51,0x52};
